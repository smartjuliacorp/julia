...
app.get('/connect', (req, res) => {
    const authUrl = `${AUTH_URL}?response_type=code&client_id=${CLIENT_ID}&scope=info%20accounts%20transactions%20offline_access&redirect_uri=${REDIRECT_URI}&providers=bankinter`;
